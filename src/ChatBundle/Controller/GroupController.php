...
use ChatBundle\Entity\Group;
use ChatBundle\Form\GroupType;
...
class GroupController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $groups = $em->getRepository('ChatBundle:Group')->findAll();
    ...
    {
        $group = new Group();
        $form = $this->createForm('ChatBundle\Form\GroupType', $group);
    ...
    {
        $deleteForm = $this->createDeleteForm($group);
        $editForm = $this->createForm('ChatBundle\Form\GroupType', $group);
